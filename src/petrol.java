public class petrol extends car{
    ...
    public petrol(String model, int year, String motor, double tank , double km_for_ful_tank, double km_on_refill) {
    ...
    public petrol(String model, int year, double tank) {
        super(model, year);
        this.tank = tank;
    }

    public petrol(String model, double km_on_refill) {
        super(model);
        this.km_on_refill = km_on_refill;
    }
