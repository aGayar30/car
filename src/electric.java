...
private double km_for_full_charge;
    ...
    public electric(String model, int year, String motor, double battery, double km_on_recharge, double km_for_full_charge) {
    ...
    public electric(String model, int year, String motor, double battery) {
        super(model, year, motor);
        this.battery = battery;
    }

    public electric(String model, int year) {
        super(model, year);
    }

    public electric(String model, double battery) {
        super(model);
        this.battery = battery;
    }
